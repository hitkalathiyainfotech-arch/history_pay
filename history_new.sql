...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2024 at 07:09 AM
...
CREATE TABLE `permissions` (
  ...
  `is_admin_added` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `purchase` (
  ...
  `transaction_key` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `settings` (
  ...
  `isAppRemove` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `isShowFailPurchase` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `isShowPurchaseEntryInFirebase` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  ...
  `isTestAd` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `isAdmobAndFBMeditation` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `facebook_ads` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `fb_native_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fb_native_banner_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fb_banner_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fb_medium_rectangle_250` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fb_interstitial_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fb_rewarded_video_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admob_ads_id` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `admob_native_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admob_banner_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admob_interstitial_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admob_rewarded_video_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admob_app_open` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admob_ads` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `payment_gateway` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `razor_pay` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `razor_merchant_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `razor_solt_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payu_new` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `payu_new_merchant_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payu_new_solt_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payu_old` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `payu_old_merchant_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payu_old_solt_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cash_free` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `cash_merchant_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cash_solt_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paytm` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `paytm_merchant_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paytm_solt_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `upi` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `upi_merchant` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `in_app_purchase` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `show_all_world` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `outside_india` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `show_all_user` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `app_update` int(11) DEFAULT 0,
  `show_user_count` int(11) DEFAULT NULL,
  `app_id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `applovin_ads` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `applovin_small_native_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `applovin_medium_banner_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `applovin_large_native_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `applovin_interstitial_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `applovin_rewarded_video_ad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `upi_api` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `upi_api_merchant_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `upi_api_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `upi_api_call_back_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `login_with` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Admin', 'harnisha111gajera@gmail.com', NULL, '$2y$10$VYh9gE2xAQZlkycJnB/GCesELQMJtV80bdggKDv9E3z8PpzumjuOW', NULL, '1', NULL, NULL, NULL, NULL, NULL, '2023-08-01 16:20:12', '2023-08-01 00:00:00', 1);
